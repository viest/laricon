...
namespace Vikin\Laricon\Generator;

use Vikin\Laricon\Exceptions\LariconErrorException;
...
class GdGenerator extends BaseGenerator implements GeneratorInterface
{
    ...
    public function __construct()
    {
        if (!extension_loaded('gd')) {
            throw new LariconErrorException('GD does not appear to be available in your PHP installation. Please try another generator');
        }
    }
